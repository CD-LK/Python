...
class MyWin(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.ui.actionHelp.triggered.connect(self.HelpButt)  # Подскази
        ###
    ...
    def OpenData(self):
        ...
        msgBox.setWindowTitle("Желаете продолжить?")
    ...
    def Search(self):
        ...
        if coll.estimated_document_count() == 0:
            QtWidgets.QMessageBox.about(self, 'Error', "Current Database empty")
        else:
    ...
    def SaveRow_inDB(self):
        ...
        try:
            ...
            QtWidgets.QMessageBox.about(self, 'Error', 'Cloum ' + str(i + 1) + ' empty')
            return 1
    ...
    def Update_Data(self):
        # self.status.showMessage('Обновляеться только выбранная строка')
        tabel = self.ui.tableWidget
        current_row = tabel.currentRow()
        if current_row == -1:
            QtWidgets.QMessageBox.about(self, 'Error', "Unselected row.")
