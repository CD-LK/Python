...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.serchLogin.setGeometry(QtCore.QRect(10, 220, 181, 31))
        self.serchLogin.setObjectName("serchLogin")
        self.serchData = QtWidgets.QPushButton(self.centralwidget)
        self.serchData.setGeometry(QtCore.QRect(10, 300, 181, 31))
        ...
        self.dateTimeEdit.setGeometry(QtCore.QRect(10, 260, 181, 31))
        self.dateTimeEdit.setCurrentSection(QtWidgets.QDateTimeEdit.DaySection)
        self.dateTimeEdit.setObjectName("dateTimeEdit")
        self.AnalizFile_2 = QtWidgets.QPushButton(self.centralwidget)
        self.AnalizFile_2.setGeometry(QtCore.QRect(10, 170, 181, 41))
        self.AnalizFile_2.setObjectName("AnalizFile_2")
...
"а"))
        ...
        self.AnalizFile_2.setText(_translate("MainWindow", "Перейти к текущему\n"
" элементу"))
